...
public class HarvestHistoryRepositoryTest extends AbstractSpringDataTest {
    ...
    public void testFindOne() {
        ...
        assertEquals(history2, _repo.findById(history2.getId()));
        assertEquals(history1, _repo.findById(history1.getId()));
    }
    ...
    public void testMarkAllAsDeleted() {
        ...
        assertTrue(_repo.findById(history2.getId()).isPresent());
    }
    ...
    public void testDeleteAllById() {
        ...
        assertNull(_repo.findById(history1.getId()));
    }
